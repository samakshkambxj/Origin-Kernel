...
recomp_algorithm  	RW	show and change the recompression algorithm
recompress        	WO	trigger page recompression
======================  ======  ===============================================
...
(secondary) compression algorithm. The basic idea is that alternative
